# OpenSesame
Makes you become the owner of a door before opening it, should reduce issues with being unable to open doors in multiplayer. No guarantees though, this mod is in beta.
...
| Github Repository: | <img height="18" src="https://github.githubassets.com/favicons/favicon-dark.svg"></img><a href="https://github.com/searica/OpenSesame"> DiscoveryPins</a> |
|-----------|---------------|
